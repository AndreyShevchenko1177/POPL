      ...
      {data.map((el, key) => (
        <div key={key} style={{
          ...
          {el.image || (generalSettingsData && generalSettingsData[3])
            ...
            }} src={`${el.image ? process.env.REACT_APP_BASE_FIREBASE_PHOTOS_URL + el.image : `${process.env.REACT_APP_BASE_FIREBASE_CUSTOM_ICON}${generalSettingsData[3]}`}?alt=media`} alt='avatar' />
            : <div style={{
