  ...
  return (
    <React.Fragment>
      <div className={classes.rootDiv}>
        <Typography
          variant='subtitle1'
          classes={{ subtitle1: classes.heading }}
        >
        Enter the emails you'd like to create accounts for. If an email already has an account associated with it, an email invite will be sent to this email to join your dashboard
        </Typography>
