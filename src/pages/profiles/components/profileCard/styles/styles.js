...
export default makeStyles((theme) => ({
  ...
  logo: {
    ...
    bottom: -0,
    zIndex: 100,
    boxShadow: "0px 4px 5px 1px rgb(0 0 0 / 20%), 0px 3px 4px 0px rgb(0 0 0 / 14%), 0px 1px 8px 0px rgb(0 0 0 / 12%)",
    borderRadius: "50%",
    "& img": {
      width: "100%",
      height: "100%",
  ...
  proLogo: {
    ...
    left: 5,
    borderRadius: "50%",
    // boxShadow: "0px 04px 5px 1px rgb(0 0 0 / 20%), 0px 3px 4px 0px rgb(0 0 0 / 14%), 0px 1px 8px 0px rgb(0 0 0 / 12%)",
    zIndex: 100,
  },
  verifiedLogo: {
    width: 25,
